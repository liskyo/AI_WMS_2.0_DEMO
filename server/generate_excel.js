...
// Save to Desktop for user access
const userDesktop = "C:\\Users\\sky.lo\\Desktop\\倉庫出入料系統";
const outputPath = path.join(userDesktop, '料件主檔匯入範本_10筆.xlsx');
...
try {
    ...
    XLSX.writeFile(wb, 'item_master_import.xlsx');
    console.log('Saved to current directory as fallback');
}
